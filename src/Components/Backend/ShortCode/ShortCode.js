...
const ShortCode = ({ shortcode }) => {
    ...
    return (
        <div className="audioPlayerShortCode">
            <div className="audioPlayerShortCodeInner">
                <div className="audioPlayerShortCodeInputWrapper">
                    <span ref={tooltip} className="tooltip">
                        Copy To Clipboard
                    </span>

                    <div className="audioPlayerShortCodeInput">
                        <input
                            ref={inputRef}
                            readOnly
                            value={shortcode}
                    ...
                    <div className="audioPlayerShortCodeCopyBtn" onClick={handleCopy}>
                        {copied ? (
                            "✓"
                        ) : (
                            <svg
                ...
                <div className="audioPlayerShortCodeHeader">
